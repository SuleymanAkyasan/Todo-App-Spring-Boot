...
import com.suleyman.springboot.todos.entity.Authority;
import com.suleyman.springboot.todos.entity.User;
import com.suleyman.springboot.todos.repository.UserRepository;
...
import com.suleyman.springboot.todos.util.FindAuthenticatedUser;
...
public class UserServiceImpl implements UserService {
    ...
    public void updatePassword(PasswordUpdateRequest passwordUpdateRequest) {
        ...
        if (!isNewPasswordConfirmed(passwordUpdateRequest.getNewPassword(), passwordUpdateRequest.getNewPassword2())) {
            throw new ResponseStatusException(HttpStatus.BAD_REQUEST, "New password is don't match");
        }
